...
public class LoginTest {
    ...
    public void validLogin() {
        ...
        //Assert.assertTrue("Button LogOut is not displayed",isButtonLogOutVisible());
    ...
    //return webDriver.findElement(By.xpath(".//*[@class='btn logout_btn']")).isDisplayed();
    @Test
    public void signUp() {
        ...
        //webDriver.findElement(By.xpath(".//*[@href='https://www.montado.pt/en/home' and text()='Home']")).click();

       // webDriver.findElement(By.xpath(".//*[@class='nav-link icon-user dropdown-toggle']")).click();
        //webDriver.findElement(By.xpath(".//*[@class='dropdown-menu']")).click();
       // webDriver.findElement(By.xpath(".//*[@data-request='onLogout']")).click();
